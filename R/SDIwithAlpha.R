# SDI function but can take alpha.
# very early implementation, will become SDI


SDIwithAlpha <- function (flows, nodes = NULL,  distance.calculation = NULL, level = "vertex",
